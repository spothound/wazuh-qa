...
def main():
    ...
    arg_parser.add_argument('-a', '--managers', metavar='<manager_ip_addresses>', type=str, nargs='+', required=True,
                            default=[], help='Manager IP addresses', dest='manager_addresses')
    ...
    manager_ip_list_size = len(args.manager_addresses)
    ...
    for i in range(n_processes):
        ...
        manager_ip = args.manager_addresses[i % manager_ip_list_size]

        arguments = (
            agents, manager_ip, args.agent_protocol, args.version, args.os, args.eps, args.duration,
