...
configurations_path = os.path.join(test_data_path,
                                   'wazuh_conf_frequency.yaml' if sys.platform != 'win32' else 'wazuh_conf_frequency_win32.yaml')
...
conf_params = {'TEST_DIRECTORIES': directory_str, 'MODULE_NAME': __name__,
               'FREQUENCY': str(frequency), 'WINDOWS_AUDIT_INTERVAL': str(windows_audit_interval)}
