...
def create_files(files_with_associated_size):
    """ Creates specified files in the system using dd binary """
    """ Examples: """
    """ - '{"/tmp/testfile1": 10MB, "/tmp/testfile2": 1GB}' """
    """ - '{"C:\\testfile1": 1KB, "C:\\testfile2": 1GB}' """
    """ :param files_with_associated_file: Dict of paths and it's file size as key value """
...
def main():
    ...
    associate_files_size(files, config["file_size_specifications"])
